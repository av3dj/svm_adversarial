...
print("=========================================================================================\n")
t0 = time.time()
train_model(mnist_regular, config, False, False)
t1 = time.time()
...
print("=========================================================================================\n")
t0 = time.time()
train_model(mnist_mixed, config, False, True)
t1 = time.time()
print("\nRunning Time: " + str(t1-t0) + " seconds\n")
...
# print("=========================================================================================\n")
# t0 = time.time()
# train_model(mnist_regular, config, True, False)
# t1 = time.time()
# print("\nRunning Time: " + str(t1-t0) + " seconds\n")
...
# print("=========================================================================================\n")
# t0 = time.time()
# train_model(mnist_mixed, config, True, True)
# t1 = time.time()
# print("\nRunning Time: " + str(t1-t0) + " seconds\n")
